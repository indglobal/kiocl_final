        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="products">
                    ...
                    <li><a href="http://www.itiltd-india.com/upload/nni.html">Naini (UP)</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/rbli.html">Rae Bareli (UP)</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/mkp.html">Mankapur (UP)</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/pkd.html">Palakkad (Kerala)</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/srinagar.html">Srinagar (J&K)</a></li>
                </ul>
                ...
                <li data-toggle="collapse" data-target="#service" class="collapsed">
                 <i class="glyphicon glyphicon-play"></i><a href="javascript:void(0)"> Regional Offices <span class="arrow"></span></a> 
             	 ...
             	 <ul class="sub-menu collapse" id="service">
                    <li class="active"><a href="http://www.itiltd-india.com/upload/ro.html#nd">New Delhi</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/ro.html#ban">Bangalore</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/ro.html#kol">Kolkatta</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/ro.html#luc">Lucknow</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/ro.html#mum">Mumbai</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/ro.html#che">Chennai</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/ro.html#hyd">Hyderabad</a></li>
                    <li><a href="http://www.itiltd-india.com/upload/ro.html#bhu">Bhubaneshwar</a></li>
                </ul>
                ...
                <ul class="sub-menu collapse" id="new">
                  <li><a href="http://www.itiltd-india.com/upload/nsu1.html">Bangalore</a></li>
                </ul>
            </ul>
     </div>
</div>
