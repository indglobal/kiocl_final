      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <a href="<?php echo base_url();?>admin/add_subcatcontent" class="btn btn-block btn-success" style="width: 200px;">Add Submneu Content
              </a>             
            </h3>
           <!-- <h3 class="box-title">              
          ...
          <?php $i=1;?>
            ...
            <tr id="image_li_<?php echo $content['id']; ?>">
              ...
              <td id1="<?php echo $content['id']; ?>">
                  ...
                  <td class="edit">
                    <?php echo getCategoryname_byid($content['cat_id']);?>
                  </td>
                  <td class="edit">
                    <?php echo getCategoryname_byid($content['subcat_id']);?>
                  </td>
                   <td>
