            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add Directors </h3>
...
echo $msg;
?>
<?php if(!empty($getDirector)){
$photograph=$getDirector[0]['image'];
}else{
  $photograph="";
}
?>
    <form role="form" action="<?php echo base_url();?>admin/add_directors/<?php echo $id;?>" method="post" enctype="multipart/form-data" >
                  <div class="box-body">
                  ...
                  <input type="hidden" name="image_old" value="<?php echo $photograph;?>">
                   ...
                   <div class="form-group">
                      <label>Name:*</label>
  <input type="text" name="name" class="form-control" value="<?php  echo set_value('name');?><?php if(!empty($getDirector)){echo $getDirector[0]['name'];}?>"> 
                    <?php echo form_error('name', '<div class="error" style="color:red;">', '</div>');?>
                   </div>

         <div class="form-group">
         <label id="label">Designation:*</label>
        <input type="text" name="designation" class="form-control" value="<?php  echo set_value('designation');?><?php if(!empty($getDirector)){echo $getDirector[0]['designation'];}?>"> 
         <?php echo form_error('designation', '<div class="error" style="color:red;">', '</div>');?> 
        </div>


      <div class="form-group" id="ckeditor">
            <label id="label">Content:*</label>
      <textarea id="postBody" name="content" class="aa"><?php if(!empty($getDirector)){echo $getDirector[0]['contents'];}?><?php  echo set_value('content');?></textarea>
  ...
  <div id="list"><?php echo ($photograph!="") ? '<img src="'.base_url('assets/uploads/directors/'.$photograph).'" height="100" width="250">' : ''; ?></div>  
   </div>
