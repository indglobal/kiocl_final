      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <a href="<?php echo base_url();?>admin/add_manager" class="btn btn-block btn-success" style="width: 200px;">Add Manager
              </a>             
            </h3>
    ...
    <tbody> 
        <div style="height:10px;"></div> 
          <?php $i=1;?>
            ...
            ?>
            <tr id="image_li_<?php echo $content['manager_id']; ?>">
                
              <td id1="<?php echo $content['manager_id']; ?>">
                    <?php echo $i;?>
                  </td>
                  <td class="edit">
                  ...
                  <td>
                  <img width="60px" src="<?php echo base_url();?>/assets/uploads/manager/<?php echo $content['image'];?>">
                  </td>
                
                  <td>
                    <a href="<?php echo base_url();?>admin/add_manager/<?php echo $content['manager_id'];?>" class="btn btn-block btn-info" style="width: 59px;">Edit
                    </a>
                 
                    <a href="<?php echo base_url();?>admin/delete_manager/<?php echo $content['manager_id'];?>" class="btn btn-danger" onclick = "return delConfirm()">Delete</a>
                  </td>
                </tr>
              <?php $i++;?>
