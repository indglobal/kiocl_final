...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    shareholders_communication List
    </h1>
    <ol class="breadcrumb">
      <li>
        <a href="#">
      ...
      <li>
        <a href="#">shareholders_communication
        </a>
      </li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <a href="<?php echo base_url();?>admin/addcat" class="btn btn-block btn-success" style="width: 120px;;">Add shareholders_communication
              </a>             
            </h3>
            <h3 class="box-title">              
