      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <a href="<?php echo base_url();?>admin/addcat" class="btn btn-block btn-success" style="width: 120px;;">Add awards_accolades
              </a>             
            </h3>
            <h3 class="box-title">              
