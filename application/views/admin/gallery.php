...
<div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form name="form" method="post"><input type="text" id="add_gal" name="add_gal"><input type="button" id='save' value="Save"></form>
      </div>
...
<script>$( "#save" ).click(function( event ) { $.post( "add_gal", { add_gal: $('#add_gal').val()})
  .done(function( data ) {
