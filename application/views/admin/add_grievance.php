...
?>
    ...
    <form role="form" action="<?php echo base_url();?>admin/add_grievance/<?php echo $id;?>" method="post" enctype="multipart/form-data" >
                  <div class="box-body">
  ...
  <textarea id="postBody" name="content" class="aa"><?php if(!empty($getGrievance)){echo $getGrievance[0]['content'];}?><?php  echo set_value('content');?></textarea>
