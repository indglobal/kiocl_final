      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <a href="<?php echo base_url();?>admin/add_directors" class="btn btn-block btn-success" style="width: 200px;">Add Directors
              </a>             
            </h3>
    ...
    <tbody> 
        <div style="height:10px;"></div> 
          <?php $i=1;?>
            ...
            ?>
            <tr id="image_li_<?php echo $content['director_id']; ?>">
                
              <td id1="<?php echo $content['director_id']; ?>">
                    <?php echo $i;?>
                  </td>
                  <td class="edit">
                  ...
                  <td class="edit">
                    <?php echo $content['designation'];?>
                  </td>
                   <td>
                    <?php echo $content['contents'];?>
                  </td>
                  <td>
                  <img width="60px" src="<?php echo base_url();?>/assets/uploads/directors/<?php echo $content['image'];?>">
                  </td>
                
                  <td>
                    <a href="<?php echo base_url();?>admin/add_directors/<?php echo $content['director_id'];?>" class="btn btn-block btn-info" style="width: 59px;">Edit
                    </a>
                 
                    <a href="<?php echo base_url();?>admin/delete_directors/<?php echo $content['director_id'];?>" class="btn btn-danger" onclick = "return delConfirm()">Delete</a>
                  </td>
                </tr>
              <?php $i++;?>
