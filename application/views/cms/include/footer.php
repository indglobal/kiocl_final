 <footer class="main-footer">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets_admin/js/jquery-1.8.3.min.js">
</script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets_admin/js/jquery-ui.js">
</script>
