...
<html>
  <head>
    ...
    <link href="<?php echo base_url(); ?>assets_admin/bootstrap/css/date.css" rel="stylesheet" type="text/css" />


    <link href="<?php echo base_url(); ?>assets_admin/bootstrap/css/date1.css" rel="stylesheet" type="text/css" />   
    <!-- FontAwesome 4.3.0 -->
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"> <?php echo $this->session->userdata['is_logged_in']['username']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?php echo $this->session->userdata['is_logged_in']['username']; ?>
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url(); ?>unit/logout" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
